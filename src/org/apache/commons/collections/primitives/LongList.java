...
public interface LongList extends LongCollection {
  ...
  * @param collection the {@link LongCollection LongCollection} of elements to
  * add
  * @return <code>true</code> iff I changed as a result of this call
  *
  * @throws UnsupportedOperationException when this operation is not supported
  ...
  * works properly across different implementations of the <code>LongList</code>
  * interface.)
  *
  ...
  * <p>
  * The hash code of an <code>LongList</code> is defined to be the result of the
  ...
  * <i>toIndex</i>, exclusive. The returned <code>LongList</code> is backed by
