 ...
 */
public class ArrayShortList extends RandomAccessShortList implements
 Serializable {
  ...
  *
  * @see
  * ArrayShortList#addAll(org.apache.commons.collections.primitives.ShortCollection)
  * @param that the non-<code>null</code> collection of <code>short</code>s to
  * add
 ...
 private void checkRangeIncludingEndpoint(int index) {
  if (index < 0 || index > _size) {
   throw new IndexOutOfBoundsException("Should be at least 0 and at most "
    + _size + ", found " + index);
  }
 }
  ...
  */
 public short[] toBackedArray() {
  trimToSize();
  short[] old_data = _data;
  _size = 0;
  _data = new short[0];
  return old_data;
 }
