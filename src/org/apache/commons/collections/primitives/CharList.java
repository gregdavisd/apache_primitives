...
public interface CharList extends CharCollection {
  ...
  * @param collection the {@link CharCollection CharCollection} of elements to
  * add
  * @return <code>true</code> iff I changed as a result of this call
  *
  * @throws UnsupportedOperationException when this operation is not supported
  ...
  * works properly across different implementations of the <code>CharList</code>
  * interface.)
  *
  ...
  * <p >
  * The hash code of an <code>CharList</code> is defined to be the result of the
  ...
  * <i>toIndex</i>, exclusive. The returned <code>CharList</code> is backed by
