...
/**
 * A primitive boolean based Stack. The underlying backing store is an ArrayBooleanList where the front of the list is
 * the bottom of the stack and the tail of the list is the top of the stack.
 *
...
public class BooleanStack {
	...
	/**
	 * Returns the 1-based position where a value is on this stack. If the value occurs as an item in this stack, this
	 ...
	 * @return the 1-based position from the top of the stack where the int is located; the return value -1 indicates that
	 * the int is not on the stack
	 */
	...
	/**
	 * Gets items from the stack where the index is zero based and the top of the stack is at an index of size()-1 with the
	 * bottom of the stack at an index of 0.
	 *
