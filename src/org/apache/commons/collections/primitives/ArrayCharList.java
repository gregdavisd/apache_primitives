 ...
 */
public class ArrayCharList extends RandomAccessCharList implements
 Serializable {
  ...
  *
  * @see
  * ArrayCharList#addAll(org.apache.commons.collections.primitives.CharCollection)
  * @param that the non-<code>null</code> collection of <code>char</code>s to
  * add
