...
public interface DoubleList extends DoubleCollection {
  ...
  * @param collection the {@link DoubleCollection DoubleCollection} of elements
  * to add
  * @return <code>true</code> iff I changed as a result of this call
  *
  * @throws UnsupportedOperationException when this operation is not supported
 ...
 /**
  * Returns <code>true</code> iff <i>that</i> is an <code>DoubleList</code> that
  * contains the same elements in the same order as me. In other words, returns
  * <code>true</code> iff <i>that</i> is a <code>DoubleList</code> that has the
  * same {@link #size() size} as me, and for which the elements returned by its
  * {@link DoubleList#iterator iterator} are equal (<code>==</code>) to the
  ...
  * <code>DoubleList</code> interface.)
  *
  * @param that the object to compare to me
  * @return <code>true</code> iff <i>that</i> is an <code>DoubleList</code> that
  ...
  * <i>toIndex</i>, exclusive. The returned <code>DoubleList</code> is backed by
