 ...
 */
public class ArrayFloatList extends RandomAccessFloatList implements
 Serializable {
  ...
  *
  * @see
  * ArrayFloatList#addAll(org.apache.commons.collections.primitives.FloatCollection)
  * @param that the non-<code>null</code> collection of <code>float</code>s to
  * add
