...
public abstract class RandomAccessFloatList extends AbstractFloatCollection
 ...
 public boolean equals(Object that) {
  if (this == that) {
   ...
   for (FloatIterator thatIter = thatList.iterator(), thisIter = iterator();
    thisIter.hasNext();) {
 ...
 protected static class RandomAccessFloatListIterator extends ComodChecker
 ...
 protected static class RandomAccessFloatSubList extends RandomAccessFloatList {
  ...
  RandomAccessFloatSubList(RandomAccessFloatList list, int fromIndex,
   int toIndex) {
