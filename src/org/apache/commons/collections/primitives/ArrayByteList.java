 ...
 */
public class ArrayByteList extends RandomAccessByteList implements
 Serializable {
  ...
  *
  * @see
  * ArrayByteList#addAll(org.apache.commons.collections.primitives.ByteCollection)
  * @param that the non-<code>null</code> collection of <code>byte</code>s to
  * add
