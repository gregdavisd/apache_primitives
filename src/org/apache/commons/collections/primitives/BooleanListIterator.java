 ...
 * @see
 * org.apache.commons.collections.primitives.adapters.BooleanIteratorBooleanListIterator
 *
...
public interface BooleanListIterator extends BooleanIterator {
  ...
  * operation). The element is inserted immediately before the next element that
  * would have been returned by {@link #next}, if any, and immediately after the
  * next element that would have been returned by {@link #previous}, if any.
  * <p >
  ...
  * to {@link #next}, or the number of elements in my iteration if I have no
  * next element.
  *
 ...
 /**
  * Returns the index of the element that would be returned by a subsequent call
  * to {@link #previous}, or <code>-1</code> if I have no previous element.
  *
  ...
  * has yet been called, or {@link #remove} or {@link #add} has already been
