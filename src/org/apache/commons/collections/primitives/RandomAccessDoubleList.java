...
public abstract class RandomAccessDoubleList extends AbstractDoubleCollection
 ...
 public boolean equals(Object that) {
  if (this == that) {
   ...
   for (DoubleIterator thatIter = thatList.iterator(), thisIter = iterator();
    thisIter.hasNext();) {
 ...
 protected static class RandomAccessDoubleListIterator extends ComodChecker
 ...
 protected static class RandomAccessDoubleSubList extends RandomAccessDoubleList {
  ...
  RandomAccessDoubleSubList(RandomAccessDoubleList list, int fromIndex,
   int toIndex) {
