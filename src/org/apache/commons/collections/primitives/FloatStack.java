 ...
 * ArrayFloatList where the front of the list is the bottom of the stack and the
...
public class FloatStack {
  ...
  * stack is at an index of size()-1 with the bottom of the stack at an index of
  * 0.
  *
