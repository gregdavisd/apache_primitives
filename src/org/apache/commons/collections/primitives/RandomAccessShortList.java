...
public abstract class RandomAccessShortList extends AbstractShortCollection
  ...
  * @param action
  */
 public void forEach(Consumer<Short> action) {
...
//-------------------------------------------------------------------------
 ...
 public boolean equals(Object that) {
  if (this == that) {
   ...
   for (ShortIterator thatIter = thatList.iterator(), thisIter = iterator();
    thisIter.hasNext();) {
 ...
 protected static class RandomAccessShortListIterator extends ComodChecker
 ...
 protected static class RandomAccessShortSubList extends RandomAccessShortList {
  ...
  RandomAccessShortSubList(RandomAccessShortList list, int fromIndex,
   int toIndex) {
