...
public interface ByteList extends ByteCollection {
  ...
  * @param collection the {@link ByteCollection ByteCollection} of elements to
  * add
  * @return <code>true</code> iff I changed as a result of this call
  *
  * @throws UnsupportedOperationException when this operation is not supported
  ...
  * works properly across different implementations of the <code>ByteList</code>
  * interface.)
  *
  ...
  * <p >
  * The hash code of an <code>ByteList</code> is defined to be the result of the
  ...
  * <i>toIndex</i>, exclusive. The returned <code>ByteList</code> is backed by
