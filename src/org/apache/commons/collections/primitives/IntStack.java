...
public class IntStack {
	...
	/**
	 * Returns the 1-based position where an int is on this stack. If the int occurs as an item in this stack, this method
	 * returns the distance from the top of the stack of the occurrence nearest the top of the stack; the topmost item on
