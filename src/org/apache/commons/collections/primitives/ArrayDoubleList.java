...
/**
 * An {@link DoubleList} backed by an array of <code>double</code>s. This implementation supports all optional methods.
 *
...
public class ArrayDoubleList extends RandomAccessDoubleList implements DoubleList, Serializable {
	...
	/**
	 * Constructs a list containing the elements of the given collection, in the order they are returned by that
	 * collection's iterator.
	 *
	 * @see ArrayDoubleList#addAll(org.apache.commons.collections.primitives.DoubleCollection)
	 * @param that the non-<code>null</code> collection of <code>double</code>s to add
	...
	//-------------------------------------------------------------------------
	/**
	 * Increases my capacity, if necessary, to ensure that I can hold at least the number of elements specified by the
	 * minimum capacity argument without growing.
	 */
