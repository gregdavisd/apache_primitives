...
public class ArrayDoubleList extends RandomAccessDoubleList implements
  ...
  *
  * @see
  * ArrayDoubleList#addAll(org.apache.commons.collections.primitives.DoubleCollection)
  * @param that the non-<code>null</code> collection of <code>double</code>s to
  * add
