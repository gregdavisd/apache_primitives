...
/**
 * A primitive double based Stack. The underlying backing store is an ArrayDoubleList where the front of the list is the
 * bottom of the stack and the tail of the list is the top of the stack.
 *
