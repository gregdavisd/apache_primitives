 ...
 */
public class ArrayLongList extends RandomAccessLongList implements
 Serializable {
  ...
  *
  * @see
  * ArrayLongList#addAll(org.apache.commons.collections.primitives.LongCollection)
  * @param that the non-<code>null</code> collection of <code>long</code>s to
  * add
